...
<script>
    ...
    function importSample() {
        ...
        input.onchange = e => {
            ...
            TracksArray.update(tracks => [...tracks, { id: tracks.length, trackName: "sample", sample: url, instrumentIcon: waveformIcon, color: "#004491", volume: 50, pan: 50, panAngle: 0, muted: false, soloed: false, regions: [] }]);
        };
        input.click();
    }
</script>
