...
<script>
    ...
    function importSample() {
        ...
        input.onchange = e => {
            ...
            TracksArray.update(tracks => [...tracks, { id: tracks.length, instrument: "sample", sample: url, instrumentIcon: waveformIcon, color: "#00bf00", volume: 50, pan: 50, panAngle: 0, muted: false, soloed: false, regions: [] }]);
        };
        input.click();
    }
</script>
